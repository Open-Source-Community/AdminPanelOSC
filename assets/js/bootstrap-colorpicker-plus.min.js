...
!function (a) {
    ...
    h.prototype = {
        constructor: h, custom: function () {
            var b = a(this.element), e = a(this.colorInput).val();
            d[d.length] = e;
            var f = a(".nonecell", b), h = g(e, f.first());
            h.removeClass("nonecell"), h.addClass("colorcell"), c.setItem("colorpickerplus_custom_colors", d.join("$"))
        }, select: function (b) {
            var c = a(this.element), d = a(b.target).data("color");
            if (null == d) c.trigger("changeColor", [d]); else {
            ...
            var c = a(this.element), d = a(".colorcell", c);
        ...
        return this.each(function () {
            var d = a(this), e = d.data("colorpickerembed"), f = "object" == typeof b ? b : {};
    ...
    p.version = "0.1.0", p.prototype = {
        constructor: p, destroy: function () {
            ...
            var c = a(this.element), d = a(b.target), e = d.closest(".colorpicker, .colorpickerplus");
        ...
        var c = arguments;
        return this.each(function () {
            var d = a(this), e = d.data("colorpickerplus"), f = "object" == typeof b ? b : {};
