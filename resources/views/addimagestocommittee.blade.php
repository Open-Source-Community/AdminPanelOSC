...
@section('body')
    ...
    <div class="container marketing">
        ...
        <div class="container">
            <h1 style="text-align: center;">Add Images To Committee</h1>
            <br>
            <form class="form-horizontal" role="form" method="post" action="/addimagestoCommittee">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" name="submit" class="btn btn-default">Add Image</button>
                    </div>
                </div>
            </form>
        </div>
